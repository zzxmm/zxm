...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COMMENT='广告表\n';
...
) ENGINE=InnoDB AUTO_INCREMENT=16091 DEFAULT CHARSET=utf8mb4 COMMENT='银行1分钱支付场景订单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=132 DEFAULT CHARSET=utf8mb4 COMMENT='卡卷记录表';
...
CREATE TABLE `xys_code_base` (
  ...
  `last_edit_id` int(11) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='串码活动-串码库';
...
CREATE TABLE `xys_code_list` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `IX_BASE_CODE` (`base_id`,`code`) USING BTREE COMMENT '串码库Code复合索引'
) ENGINE=InnoDB AUTO_INCREMENT=1001 DEFAULT CHARSET=utf8mb4 COMMENT='串码表';
...
) ENGINE=InnoDB AUTO_INCREMENT=257 DEFAULT CHARSET=utf8mb4 COMMENT='串码记录表';
...
CREATE TABLE `xys_coupon` (
  ...
  `return_money` decimal(22,2) NOT NULL DEFAULT '0.00' COMMENT '分销返佣金额',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8mb4 COMMENT='卡卷表';
...
) ENGINE=InnoDB AUTO_INCREMENT=85840 DEFAULT CHARSET=utf8mb4 COMMENT='卡卷门店关系表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='分销-记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='分销-规则表';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='分销-反佣等级规则表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='分销-用户关系表';
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COMMENT='商户表\n';
...
CREATE TABLE `xys_operate_theme` (
  ...
  `operate_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '活动类型 :   0卡卷  1话费  2免支付发卡  3串码   默认0',
  ...
  `code_base_id` int(11) DEFAULT NULL COMMENT '串码库ID',
  `message` varchar(450) DEFAULT NULL COMMENT '短信内容',
  PRIMARY KEY (`id`),
  KEY `IX_CARD_STATE` (`card_state`) USING BTREE COMMENT '卡卷状态索引',
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='运营页基础信息表(含卡卷)';
...
CREATE TABLE `xys_order` (
  ...
  `cheap_price` decimal(20,2) NOT NULL DEFAULT '0.00' COMMENT '卡券优惠金额',
  `actual_price` decimal(20,2) NOT NULL DEFAULT '0.00' COMMENT '实际支付金额',
  `order_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '订单类型:  0 正常订单 , 1 拼团订单  2运营H5订单  3 公众号订单  4串码订单',
  `main_openid` varchar(64) DEFAULT NULL COMMENT '主商户openid',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `IX_order_state` (`order_state`) USING BTREE COMMENT 'state索引',
  KEY `IX_wechat_openid` (`wechat_openid`) USING BTREE COMMENT 'openid索引',
...
) ENGINE=InnoDB AUTO_INCREMENT=632 DEFAULT CHARSET=utf8mb4 COMMENT='订单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=631 DEFAULT CHARSET=utf8mb4 COMMENT='订单详情表\n';
...
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8mb4 COMMENT='限购规则表';
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COMMENT='充值订单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb4 COMMENT='售卖规则表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4245 DEFAULT CHARSET=utf8mb4 COMMENT='门店表\n';
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COMMENT='商户类型关系表\n';
...
CREATE TABLE `xys_user` (
  ...
  `user_password` varchar(64) DEFAULT NULL COMMENT '账号密码',
  ...
  `branch_money` decimal(20,2) NOT NULL DEFAULT '0.00' COMMENT '分销收益金额',
  `branch_number` int(11) NOT NULL DEFAULT '0' COMMENT '分销邀请人数',
  `branch_withdrawable_money` decimal(20,2) NOT NULL DEFAULT '0.00' COMMENT '分销可提现金额',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `IX_user_center_id` (`user_center_id`) USING BTREE COMMENT 'centerid索引',
  KEY `IX_openid` (`openid`) USING BTREE COMMENT 'openid索引'
...
CREATE TABLE `xys_website_customer` (
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '申请时间',
  `state` tinyint(4) NOT NULL DEFAULT '0' COMMENT '处理状态 0待回访  1已回访',
  ...
  KEY `IX_TIME` (`create_time`) USING BTREE COMMENT '时间索引'
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='客户合作申请记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='案例图片';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='官网图文表';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='白名单库';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='全局活动上线控制表';
