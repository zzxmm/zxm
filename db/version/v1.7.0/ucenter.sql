...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COMMENT='商户基本信息（登录用）';
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COMMENT='商户通讯信息表';
...
CREATE TABLE `merchant_detail` (
  ...
  UNIQUE KEY `UK_merchant_id` (`merchant_id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COMMENT='商户详细信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=4250 DEFAULT CHARSET=utf8mb4 COMMENT='门店基本信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=4245 DEFAULT CHARSET=utf8mb4 COMMENT='门店通讯信息表';
...
CREATE TABLE `store_detail` (
  ...
  PRIMARY KEY (`detail_id`),
  UNIQUE KEY `UK_store_id` (`store_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4250 DEFAULT CHARSET=utf8mb4 COMMENT='门店详细信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=12132 DEFAULT CHARSET=utf8mb4 COMMENT='用户基本信息（登录用）';
...
) ENGINE=InnoDB AUTO_INCREMENT=12129 DEFAULT CHARSET=utf8mb4 COMMENT='用户详情';
